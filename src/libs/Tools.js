...
export const LOCALES = [
  { name: LANG.ua, caption: 'Українська', image: require('./locales/flags/ua.png') },
  { name: LANG.en, caption: 'English', image: require('./locales/flags/en.png') },
  { name: LANG.ru, caption: 'Русский', image: require('./locales/flags/ru.png') },
];

export const getLocale = (lang) => {
  let locale = null;
  switch(lang) {
    case LANG.en: locale = require('./locales/EN').default; break;
    case LANG.ru: locale = require('./locales/RU').default; break;
    default: locale = require('./locales/UA').default;
  }
  return locale;
}
...
export const getMedia = (lang) => {
  let media = null;
  switch(lang) {
    case LANG.en: media = require('./media/EN').default; break;
    case LANG.ru: media = require('./media/RU').default; break;
    default: media = require('./media/UA').default;
  }
  return media;
}
...
export const CheckOnline = async () => {
  ...
  console.log('CheckOnline => state:', state);
  if (state) {
    return true;
  } else {
		return false;
