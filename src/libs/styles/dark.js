export default {
  ...
  //--------------------------------------------------------------------------------------------------
  ActionMenuIcon: { color: '#007BFF', fontSize: 23, paddingHorizontal: 15, paddingVertical: 3 },
  ActionBackIcon: { color: '#007BFF', fontSize: 23, paddingHorizontal: 15, paddingVertical: 3 },
  //--------------------------------------------------------------------------------------------------
  ...
  Profile: {
    ...
    InputDefault: {
      ...
      padding: 0, paddingHorizontal: 5, margin: 0,
    },
		InputNotModif: {
